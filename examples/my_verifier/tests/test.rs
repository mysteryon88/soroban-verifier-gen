...
use my_verifier::{MyGroth16Verifier, MyGroth16VerifierClient, Proof};
...
fn create_client(e: &Env) -> MyGroth16VerifierClient<'_> {
    let contract_id = e.register(MyGroth16Verifier {}, ());
    MyGroth16VerifierClient::new(e, &contract_id)
}
